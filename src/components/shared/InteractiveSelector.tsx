...
import { Box, ButtonBase, ClickAwayListener, Paper, Popper, type SxProps, type Theme } from '@mui/material'

type InteractiveSelectorChildren = React.ReactNode | ((args: {
  close: () => void
  isOpen: boolean
}) => React.ReactNode)
...
interface InteractiveSelectorProps {
  ...
  children: InteractiveSelectorChildren
}

const resolveChildren = (
  children: InteractiveSelectorChildren,
  args: { close: () => void; isOpen: boolean },
...
const InteractiveSelector: React.FC<InteractiveSelectorProps> = ({
  ...
  const resolvedMenuMinWidth = useMemo(() => menuMinWidth ?? minWidth ?? width, [menuMinWidth, minWidth, width])
