...
const TRANSLATIONS: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    'unionRaid.filter.stats.total': '已出刀数：{count} 刀',
    'unionRaid.filter.stats.filtered': '符合条件的刀数：{count} 刀',
  ...
  en: {
    ...
    'unionRaid.filter.stats.total': 'Total strikes: {count}',
    'unionRaid.filter.stats.filtered': 'Matching strikes: {count}',
